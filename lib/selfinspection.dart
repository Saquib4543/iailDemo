                    ...
                    child: Column(children: [
                      ...
                      Center(
                        child: ElevatedButton(
                          child: odometerCar == ""
                              ? Text('Take Images',style:TextStyle(fontSize: 16,color: Colors.blue[900]))
                              : Text('Retake Images',style:TextStyle(fontSize: 16,color: Colors.blue[900])),
                          onPressed: () async {
                            showDialog(
                              context: context,
                              builder: (BuildContext context) => AlertDialog(
                                alignment: Alignment.center,
                                title: Text("Image Upload Instructions",style:TextStyle(fontSize: 16,color: Colors.blue[900])),
                                content: Container(
                                ...
                                actions: [
                                  ElevatedButton(
                                      ...
                                      child: const Padding(
                                        ...
                                        child: Text("Continue",style:TextStyle(fontSize: 16,color: Color(0xFF0D47A1))),
                                      )),
                                ],
                              ),
                            );
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                ElevatedButton(
                                    ...
                                    child: Text("Retake",style:TextStyle(fontSize: 16,color: Color(0xFF0D47A1))))
                              ],
                            ),
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  ...
                                  style: TextStyle(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600,color: Color(0xFF0D47A1)),
                                ),
                                ElevatedButton(
                                    style: ButtonStyle(
                                      backgroundColor:
